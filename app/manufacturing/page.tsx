      ...
      case 'overview':
        return (
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Production Component Search</CardTitle>
                <CardDescription>Find components for manufacturing</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Recent Production Transactions</CardTitle>
                <CardDescription>Latest component usage in manufacturing</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Monitor and manage production line requirements</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 border rounded-lg">
                      <h3 className="font-medium">Production Line A</h3>
                      <p className="text-sm text-gray-600">Components needed: 25</p>
                      <Badge variant="default" className="mt-2">Active</Badge>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h3 className="font-medium">Production Line B</h3>
                      <p className="text-sm text-gray-600">Components needed: 18</p>
                      <Badge variant="default" className="mt-2">Active</Badge>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h3 className="font-medium">Production Line C</h3>
                      <p className="text-sm text-gray-600">Components needed: 12</p>
                      <Badge variant="outline" className="mt-2">Maintenance</Badge>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h3 className="font-medium">Production Line D</h3>
                      <p className="text-sm text-gray-600">Components needed: 30</p>
                      <Badge variant="default" className="mt-2">Active</Badge>
                    </div>
                  </div>
                </div>
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Production & Components</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex justify-between items-center">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 capitalize">
                  {activeTab === 'dashboard' ? 'Manufacturing Dashboard' : 
                   activeTab === 'overview' ? 'Production Overview' :
                   activeTab === 'components' ? 'Component Search' :
                   activeTab === 'transactions' ? 'Transaction History' :
                   activeTab === 'production' ? 'Production Lines' : 'Manufacturing Dashboard'}
                </h2>
                <p className="text-gray-600">
                  {activeTab === 'dashboard' ? 'Manufacturing analytics and production metrics' :
                   activeTab === 'overview' ? 'Quick search and production activity overview' :
                   activeTab === 'components' ? 'Search and browse available components' :
                   activeTab === 'transactions' ? 'Track production component usage' :
                   activeTab === 'production' ? 'Monitor production lines and requirements' : 'Manufacturing Dashboard'}
                </p>
              </div>
            </div>
          </header>
            ...
            {activeTab === 'dashboard' && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-orange-600">{mockStats.productionLines}</div>
                    <p className="text-xs text-muted-foreground">
                      Active lines
                    </p>
                  </CardContent>
